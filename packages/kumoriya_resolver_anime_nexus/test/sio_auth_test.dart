...
void main() {
  test(
    'Socket.IO auth in CONNECT message',
    () async {
      ...
      socket
          .listen((msg) {
            ...
            final display = msgStr.length > 120
                ? msgStr.substring(0, 120)
                : msgStr;
            print('[rx] $display');
      ...
      if (gotNamespaceConnect) {
        ...
        final connectAuth = jsonEncode({
          'auth': {'ref': '', 'fingerprint': browserFingerprint},
        });
